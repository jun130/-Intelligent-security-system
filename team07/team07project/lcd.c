...
{
	// TODO implement
    GPIO_ResetBits(GPIOD, GPIO_Pin_13); // RS command mode
    GPIO_ResetBits(GPIOD, GPIO_Pin_14); // WR
    GPIO_ResetBits(GPIOC, GPIO_Pin_6); // CS start

	GPIO_Write(GPIOE, LCD_Reg);

	// TODO implement
    GPIO_SetBits(GPIOC, GPIO_Pin_6); // CS Stop
    GPIO_SetBits(GPIOD, GPIO_Pin_14); // WR
    GPIO_SetBits(GPIOD, GPIO_Pin_13); // RS Write data to register
}
...
static void LCD_WR_DATA(uint16_t LCD_Data)
{
    ...
    GPIO_SetBits(GPIOD, GPIO_Pin_13); // RS write mode
